...
const CategoryBaseAdsPage = async ({ searchParams, params }: TCategoryProps) => {
    ...
    const displayedProducts = categoryProducts?.length > 0 ? categoryProducts : availableProducts;
